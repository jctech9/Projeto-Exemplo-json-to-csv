...
public enum AtividadesControleColumns {
    EVENTO_RISCO(0, "eventoRisco", "Evento de Risco", 15000, true),
    OPCAO_TRATAMENTO(1, "opcaoTratamento", "Opção de\nTratamento", 6000, false),
    ...
    STATUS(5, "status", "Status", 6000, false),
    ACOES_PREVENTIVAS(
            6,
            "acoesPreventivas",
            "Ações preventivas\n(descrever)",
    ...
    MONITORAMENTO(7, "monitoramento", "Monitoramento", 15000, true),
    GATILHO(8, "gatilho", "Gatilho\n(descrever)", 15000, true),
    ACOES_CONTINGENCIA(
            9,
            "acoesContingencia",
        ...
        RESPONSAVEL_CONTINGENCIA(10, "responsavelContingencia", "Responsável", 7000, false);
